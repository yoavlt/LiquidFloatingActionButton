...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                      ...
                      Forked from: https://github.com/yoavlt/LiquidFloatingActionButton
                       DESC

  s.homepage         = "https://github.com/shotaroikeda/LiquidFloatingActionButton"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Shotaro Ikeda" => "ikeda.shot@gmail.com" }
  s.source           = { :git => "https://github.com/shotaroikeda/LiquidFloatingActionButton.git", :tag => s.version.to_s }
  ...
  # Error in podspec if this is enabled
  # s.resource_bundles = {
